...
public class AutoElevatorkLevel1AndAHalf extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final ElevatorSubsystem m_elevatorSubsystem;
 private double elevatorCurrentTarget = ElevatorSetpoints.kLevel1AndAHalf;
  /**
   * Creates a new ExampleCommand.
   *
   * @param subsystem The subsystem used by this command.
   */
  public AutoElevatorkLevel1AndAHalf(ElevatorSubsystem subsystem) {
